  ...
  return (
    <div>
      ...
      <div className="grid sm:grid-cols-4 gap-4 mb-8">
        ...
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <p className="text-sm text-slate-500 mb-1">新築価格</p>
          <p className="text-3xl font-bold text-blue-700">{txStats?.newConstruction ?? "—"}</p>
          <p className="text-xs text-slate-400 mt-1">件</p>
        </div>
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <p className="text-sm text-slate-500 mb-1">売り出し価格</p>
          <p className="text-3xl font-bold text-amber-600">{txStats?.listing ?? "—"}</p>
          <p className="text-xs text-slate-400 mt-1">件</p>
        </div>
        <div className="bg-white rounded-xl border border-slate-200 p-5">
          <p className="text-sm text-slate-500 mb-1">成約価格</p>
          <p className="text-3xl font-bold text-green-700">{txStats?.transaction ?? "—"}</p>
          <p className="text-xs text-slate-400 mt-1">件</p>
        </div>
      </div>
